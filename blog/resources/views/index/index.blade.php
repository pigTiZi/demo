        ...
        <div class="right fr">
            ...
            <div class="fr">
                ...
                @if ($username['username'])
                        <li><h3>{{$username['username']}}欢迎登陆</h3></li>
                    @else
                        <li><a href="login" target="login">登录</a></li>
                        <li>|</li>
                        <li><a href="reg" target="reg" >注册</a></li>
                        <li>|</li>
                    @endif
                    <li><a href="">消息通知</a></li>
                </ul>
...
<div class="banner_x center">
    ...
    <div class="search fr">
        <form action="search_goods" method="get">
            {{csrf_field()}}
            <div class="text fl">
                <input type="text" name="searchGoods" class="shuru"  placeholder="小米6&nbsp;小米MIX现货">
            </div>
            <div class="submit fl">
